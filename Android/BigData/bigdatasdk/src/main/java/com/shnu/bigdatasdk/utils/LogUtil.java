    ...
    public static class Builder {
        ...
        public Builder() {
            if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
                dir = BaseApplication.getInstance().getExternalCacheDir() + File.separator + "log" + File.separator;
            } else {
                dir = BaseApplication.getInstance().getCacheDir() + File.separator + "log" + File.separator;
            }
        }
